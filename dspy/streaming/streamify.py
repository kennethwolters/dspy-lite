...
def _is_litelm_model_response_stream(value: Any) -> bool:
    cls = type(value)
    return cls.__name__ == "ModelResponseStream" and cls.__module__.startswith("litelm")
    ...
    async def async_streamer(*args, **kwargs):
        ...
        async with create_task_group() as tg, send_stream, receive_stream:
            ...
            async for value in receive_stream:
                if _is_litelm_model_response_stream(value):
...
async def streaming_response(streamer: AsyncGenerator) -> AsyncGenerator:
    ...
    async for value in streamer:
        ...
        elif _is_litelm_model_response_stream(value):
